/*
===============================================================================
🏛️ WORKSHOP EXERCISES: Group B - Go JSON-RPC 2.0 Router
===============================================================================
Welcome to Group B's A2A Message Router!
...
/*
===========================================================================
TODO (Group B - Exercise 2): Process A2A JSON-RPC `message/send` Requests
===========================================================================
Steps to implement:
...
func HandleJSONRPC() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Unmarshal msg, extract facts & variance, and invoke EvaluateContractPolicy
		// -------------------------------------------------------------------------
		var msg A2AMessage
